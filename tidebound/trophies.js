...
(function (G) {
  ...
  TR.LIST = [
    ...
    { id: 'whole_chart', e: '🗺️', name: 'The Whole Chart', sub: 'Every walkable mile of Vessakai, surveyed and inked by one pair of boots. The Crown watches, uncharted, as is its right.', hint: 'The Wayfinder still has blank country on it.', test: (s) => !!(s && TB.Map && TB.Map.charted && TB.Map.charted(s)) },
