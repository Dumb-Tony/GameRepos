...
(function (G) {
  ...
  TB.scene('ch6_terrace', {
    ...
    text: (s) => [
      ...
      s.companion === 'buri' ? 'Buri takes the ten thousand stairs as a personal enemy and defeats them one by one, with commentary. By the top of the fourth flight he has opinions about the Kaari\'s attitude to ramps.' : s.companion === 'vela' ? 'Vela rides the mountain\'s standing wind alongside the stair, level with you, then above — and for once she doesn\'t range. She keeps station. Escort formation, the whole climb.' : s.companion === 'kavi' ? 'Kavi climbs the stair the way he entered your camp two months ago: committed and hating it. This is not his country — no cover, no scent-map, stone underfoot instead of honest ground — and he does it anyway, one flight below you or one above, triangulating the whole climb around the fixed point of your back.' : s.companion === 'ipo' ? 'Ipo rides your shoulder up the first three flights like a rajah surveying new taxes — then the height of the place gets into him, and he goes quiet, small hand knotted in your collar. Somewhere past the sixth flight he starts, very softly, doing the thing you\'ve never heard from him: humming. It takes you a hundred steps to place the tune. It\'s the Hum. He\'s harmonizing.' : s.companion === 'moa' ? 'Moa marches the stairs. All of them. Offered the pack-top perch she declines it with one affronted feather-shake and takes each tread on her own two feet, a small copper sergeant reviewing ten thousand parade grounds, muttering at the state of the weeds between the stones.' : s.companion === 'nine' ? 'Nine cannot climb this with you, and the goodbye at the tideline this morning had a weight you both pretended not to feel — one arm around your ankle, one long look, then the water folding shut over her like a door being politely closed. Every stream the stair crosses, you find yourself checking the pools. You know it\'s absurd. You check them anyway.' : 'You climb alone, and the stair does what enormous old things do to a person alone: it makes room for you. By the fortieth flight the rhythm of your boots on the spoon-worn stone is a kind of company in itself — yours, and everyone\'s who ever wore the stone into spoons.',
  ...
  TB.scene('ch6_tremor', {
    ...
    text: (s) => [
      ...
      s.companion === 'moa' ? 'Moa knows first — a full minute first: she goes rigid on your pack, issues one flat mechanical note you have never heard from her, and every bird on the mountainside goes up at once like thrown grain—' : s.companion === 'kavi' ? 'Kavi knows first — a full minute first: he stops mid-stride, drops his head below his shoulders, and braces all four feet against ground that hasn\'t moved yet. Then the birds go up, every wing on the mountainside at once—' : s.companion === 'buri' ? 'Buri knows first — a full minute first: he plants himself broadside across the trail ahead of you, an immovable roadblock with his snout to the stone, reading the mountain through his feet. Then the birds go up, every wing at once—' : s.companion === 'vela' ? 'Vela knows first — a full minute first: she drops out of the standing wind without a wingbeat and lands ON you, talons careful, wings half-mantled around your head. She has never once done this. Then the birds go up, the whole mountainside at once—' : s.companion === 'ipo' ? 'Ipo knows first — a full minute first: he goes from your shoulder to your chest, inside your jacket, small heart hammering against yours, gripping like the tree is already falling. Then the birds go up, every wing on the mountainside at once—' : 'The birds know first: every wing on the mountainside goes up at once, a rattling sheet of them against the blue—',
  ...
  TB.scene('ch6_inner', {
    ...
    text: (s) => {
      // the night on bedrock: the ascent's last camp, dealt by companion
      const BEDROCK = {
        kavi: 'The night on bedrock is long, and Kavi stands the whole of it — not sleeping, not pacing, just standing at the camp\'s uphill edge with his back to the fire, a grey wall between you and the mountain\'s bad mood. Twice the ground murmurs. Twice, without turning, he leans his weight back against your legs: <em>still here. Still held.</em>',
        ipo: 'On bedrock, in the cold, Ipo abandons every treaty line the two of you ever negotiated and sleeps inside your jacket, over your heart. When the ground murmurs after midnight he doesn\'t wake — but his small hand closes on a fistful of your shirt, and holds it, the way you\'d hold a rail.',
        vela: 'Vela roosts on the pack-frame a hand\'s reach from your head — the closest she has ever slept in the whole of your acquaintance. When the ground murmurs after midnight, her eye is already open. You watch each other through the small hours the way sentries share a wall: nothing needing saying, both saying it.',
        buri: 'Buri arranges himself uphill of your bedroll on the bare stone — windbreak, avalanche-break, two hundred pounds of deliberate placement — and sleeps in shifts you can hear change. When the ground murmurs after midnight he answers it: one low note through the stone under you, less a sound than a fact. The mountain has opinions. So does he.',
        moa: 'Moa stands the bedrock night on your chest, facing uphill, a half-pound sentry against a volcano. It should be funny. Somewhere past midnight, when the ground murmurs and her feet grip and she does not so much as flinch, it stops being funny and becomes the bravest thing you have ever slept beneath.',
        nine: 'The bedrock night is the loneliest of the climb — no fire-ring company, no tideline — until, somewhere past midnight, you hear water moving in the rock. A channel, deep under the camp, running its seven-beat rise and fall. Nine said goodbye at the tideline — but the island\'s whole plumbing is her country, and you fall asleep with your palm flat on the stone, over the sound of it.',
      };
      const t = [
        (s.companion ? BEDROCK[s.companion] : 'The night on bedrock is the loneliest of the climb: no treeline, no surf, just you, a small fire guttering in thin air, and a mountain turning over in its sleep. Twice the ground murmurs and you sit up alone in the enormous dark — and find, both times, that what steadies you is the list itself: the fires built, the tolls paid, the hundred days of proof that you are harder to shake than ground.'),
      ...
      if (TB.is('INNER_GREEN')) {
        t.push('They meet you on the rim path — a dozen of them, silent, watchful, dressed like Naia in the colors of the walls — and at their center an old man with a staff of black wood veined with ' + (TB.knowsGlass && TB.knowsGlass(s) ? 'heartglass' : 'a dark glass that holds your lamplight a half-beat too long') + ' and eyes like the Tidewell: Tekau, Elder Speaker, who looks at you for a long moment and then speaks in slow, rust-thick English, learned — you realize with a jolt — from the same decades of listening that taught Naia:',
