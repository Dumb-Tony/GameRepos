...
- The design bible is `tidebound/design/` — treat it as the roadmap
  (49 endings designed, 39 CORES + 8 deaths implemented incl. NG+ ending
  The Loop, What Remains, The Island's Own, and The Last Delivery; secret/joke/death categories listed in `design/09-endings.md`,
