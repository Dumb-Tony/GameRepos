    ...
    public static class Endings
    {
        ...
        static readonly Dictionary<string, (string Title, string[] Body)> Cores =
            new Dictionary<string, (string, string[])>
            {
                ...
                ["LOOP"] = ("THE LOOP", new[]
                {
                    "You go back to the grotto at king tide with the journal's last line in your teeth, and you kneel at the pool, and you ask it — out loud, feeling foolish for exactly four seconds — <i>who is counting with me?</i>",
                    "And the pool answers the way the island has answered everything, all along, in every life: seven beats. But this time — knowing what you know, having written what you wrote, having <i>arrived</i> as many times as you have arrived — you finally hear the seventh beat for what it is. Not a door closing. A stroke of a tally. Something on the far side of the water is counting crossings, patiently, the way you count days in the Ledger: not to imprison. To <i>remember</i>. The island does not trap its castaways. It keeps them — the way you keep entries, the way the sea keeps salt — and what it has been humming since your first fire is not a lullaby and not a warning. It is a count, and the count includes you, and the count is not finished.",
                    "You write the new last entry with your own hand, for your own eyes, for the next time: <i>\"It isn't a loop. It's a ledger. We are being kept — carefully. Find out what for. I'll start.\"</i> And you put the tin box back on the shelf, and you walk out into the ninety-ninth morning of this life or the first morning of the next — the distinction, you suspect, was always the island's to make — and for the first time in any of your lives, the Hum sounds <i>glad</i>.",
                }),
