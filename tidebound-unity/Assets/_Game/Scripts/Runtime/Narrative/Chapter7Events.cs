        ...
        static void AddConvergence(StoryScript script)
        {
            script.Add(new StoryScene
            {
                ...
                Choices = new List<StoryChoice>
                {
                    ...
                    End("Go back to the grotto. Ask the pool who is counting with you.",
                        "The journal in your handwriting. The seventh beat. The Loop.",
                        "LOOP", s => s.Is("NGPLUS") && s.Is("LOOP_KNOWN")),
