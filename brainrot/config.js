...
(function (G) {
  ...
  // Higgsfield brainrot-meme art. The pathogen is a single centered creature
  // (drawn in the evolve panel over the procedural fallback). The sprite sheet
  ...
  BR.SPRITE_SHEET_IMG = { local: 'sprites-hd.png', url: 'https://d8j0ntlcm91z4.cloudfront.net/user_3FxomCiOZT5PR5pj4MCur1MG0Im/hf_20260711_181114_e919633a-76ca-457c-be43-3c62f2a0ce19.png',
    ...
    cells: ['toilet', 'skull', 'smirk', 'peach', 'drumstick',
            'brain', 'phone', 'robot', 'megaphone', 'unicorn',
            'flame', 'heart', 'zombie', 'tombstone', 'flask',
            'shield', 'mask', 'recycle', 'wave', 'sunglasses',
            'coin', 'star', 'spiral', 'bolt', 'globe'] };
